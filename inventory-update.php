		...
		<div class="row">
			<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
				...
				<p>
					...
					<input type="text" name="medname" value="<?php if(empty($row[1])){echo "";}else echo $row[1]; ?>">
				</p>
				<p>
				...
				<p>
					...
					<input type="text" name="cat" value="<?php if(empty($row[3])){echo "";}else echo $row[3]; ?>">
				</p>
				</div>
				...
				<p>
					...
					<input type="number" step="0.01" name="sp" value="<?php if(empty($row[4])){echo "";}else echo $row[4]; ?>">
				</p>
				<p>
					<label for="loc">Location:</label><br>
					<input type="text" name="loc" value="<?php if(empty($row[5])){echo "";}else echo $row[5]; ?>">
				</p>
				</div>
