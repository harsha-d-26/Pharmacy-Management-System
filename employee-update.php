			...
			<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
				<div class="column">
					...
					<p>
						...
						<input type="text" name="efname" value="<?php if(empty($row[1])) echo""; else echo $row[1]; ?>">
					</p>
					<p>
						<label for="elname">Last Name:</label><br>
						<input type="text" name="elname" value="<?php if(empty($row[1])) echo""; else echo $row[2]; ?>">
					</p>
					<p>
						<label for="ebdate">Date of Birth:</label><br>
						<input type="date" name="ebdate" value="<?php if(empty($row[1])) echo""; else echo $row[3]; ?>">
					</p>
					<p>
						<label for="eage">Age:</label><br>
						<input type="number" name="eage" value="<?php if(empty($row[1])) echo""; else echo $row[4]; ?>">
					</p>
					<p>
						<label for="esex">Sex:</label><br>
						<input type="text" name="esex" value="<?php if(empty($row[1])) echo""; else echo $row[5]; ?>">
					</p>
				</div>
				<div class="column">
					<p>
