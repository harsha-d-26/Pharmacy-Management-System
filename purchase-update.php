			...
			<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
				<div class="column">
					<p>
						...
						<input type="number" name="pid" value="<?php if(empty($row[1])) echo""; else echo $row[0]; ?>" readonly>
					</p>
					<p>
						<label for="sid">Supplier ID:</label><br>
						<input type="number" name="sid" value="<?php if(empty($row[1])) echo""; else echo $row[1]; ?>" readonly>
					</p>
					<p>
						<label for="mid">Medicine ID:</label><br>
						<input type="number" name="mid" value="<?php if(empty($row[1])) echo""; else echo $row[2]; ?>" readonly>
					</p>
					<p>
						<label for="pqty">Purchase Quantity:</label><br>
						<input type="number" name="pqty" value="<?php if(empty($row[1])) echo""; else echo $row[3]; ?>">
					</p>
				</div>
				...
				<div class="column">
					<p>
						...
						<input type="number" step="0.01" name="pcost" value="<?php if(empty($row[1])) echo""; else echo $row[4]; ?>">
					</p>
