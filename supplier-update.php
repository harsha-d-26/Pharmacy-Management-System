			...
			<form action="<?=$_SERVER['PHP_SELF']?>" method="post">
				<div class="column">
					...
					<p>
						...
						<input type="text" name="sname" value="<?php if(empty($row[1])) echo""; else echo $row[1]; ?>">
					</p>
					<p>
						<label for="sadd">Address:</label><br>
						<input type="text" name="sadd" value="<?php if(empty($row[1])) echo""; else echo $row[2]; ?>">
					</p>
				...
				<div class="column">
					...
					<p>
						...
						<input type="text" name="smail" value="<?php if(empty($row[1])) echo""; else echo $row[4]; ?>">
					</p>
